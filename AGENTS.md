...
| **M4** — Polish + reliability (sleep/wake, battery, prod cadence) | 🔄 in progress — M4.1/4.2/4.4/4.5 done; M4.3 cadence built (device deploy pending) + M4.6 (battery/mount) open |
